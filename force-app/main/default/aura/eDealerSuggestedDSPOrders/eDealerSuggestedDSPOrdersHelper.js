({
    doInitHelper : function(component, event, helper) {
        ...
        helper.fetchDSPSuggestedOrders(component, event, helper);
    },
    
    
    fetchDSPSuggestedOrders : function(component, event, helper) {
        ...
        var action = component.get("c.fetchDealerDSPSuggestedOrdersDetails");
        action.setParams({
            "dealerCode" : locCode,
    ...
    addItemsInEmergencyCart : function(component, event, helper, selectedOrderType) {
        var action = component.get("c.upsertItemsInDSPEmergencyCart");
        action.setParams({
    ...
    addItemsInDSPCart : function(component, event, helper, selectedOrderType) {
        var action = component.get("c.upsertItemsInDSPCart");
        action.setParams({
            "suggestedOrders"  : JSON.stringify(component.get("v.invData"))
        });
