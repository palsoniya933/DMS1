({
	...
	fetchManualLockDownData : function(component, event, helper) {
        ...
        var action = component.get("c.fetchAWSManualLockdownKPIData");
        action.setParams({
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") { 
                ...
                if(!$A.util.isEmpty(resultData.error)){
                    ...
                    component.set("v.manualLockdownData", resultData.response[0]);
                }
            }
            else if (state === "ERROR") {
