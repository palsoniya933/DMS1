({
    doInitHelper : function(component, event, helper) {
        ...
        helper.fetchDUALSuggestedOrders(component, event, helper);
    },
    
    
    fetchDUALSuggestedOrders : function(component, event, helper) {
        var locCode = component.get("v.dealerCode");
        //check selected  location/dealer code
        if($A.util.isUndefinedOrNull(locCode)){
            return;
        }
        var action = component.get("c.fetchDealerDUALSuggestedOrdersDetails");
        action.setParams({
            "dealerCode" : locCode,
    ...
    addItemsInPDC_DSP_StockCart : function(component, event, helper, selectedOrderType) {
        var action = component.get("c.upsertItemsInDSPAndPPDCStockCart");
        action.setParams({
            "suggestedOrders"  : JSON.stringify(component.get("v.invData"))
        });
