({
    ...
    getReportData : function(component, event, helper, isDownload, offset) {    
        ...
        var action = component.get("c.fetchAWSDealerSupplierReportData");
        action.setParams({
        ...
        action.setCallback(this, function(response) {            
            ...
            if (state === "SUCCESS") { 
                ...
                if(!$A.util.isEmpty(resultData.error)){
                    ...
                    if(!isDownload){
                        component.set("v.dealerSupplierReportData", resultData.response);
    ...
    setGridColumns : function(component, event, helper) {
        ...
        console.log('LT::'+languageTranslation);
        ...
        for (const key in languageTranslation) {
            ...
            if(value == 'leadtime' || value == 'transittime' || value=='monday'||
               value=='tuesday'|| value=='wednesday'|| value=='thursday'||
