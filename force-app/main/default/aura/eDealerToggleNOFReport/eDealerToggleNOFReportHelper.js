({
    ...
    getReportData : function(component, event, helper, isDownload, offset) { 
       ...
       var filterSelected = component.get("v.selectedFilters");
        ...
        console.log("reportGnerateObject.value" , reportGnerateObject.value);
       ...
       // console.log('filterSelected:::'+JSON.stringify(filterSelected));
        ...
        var action = component.get("c.fetchToggleNOFRecordsData");
        action.setParams({
        ...
        action.setCallback(this, function(response) {            
            ...
            if (state === "SUCCESS") { 
                ...
                if(!$A.util.isEmpty(resultData.error)){
                    ...
                    if(!isDownload){
                        component.set("v.toggleNOFReportData", resultData.response);
   ...
   var currencyCode = component.get("v.currencyCode");        
        for (const key in languageTranslation) {
            ...
            if(value == 'on_hand' || value == 'consecutive_days' || value=='on_order' || 
               value=='P_12monthHits' || value=='P_12MonthsDemand'|| value=='ABCUNITTOT'){
