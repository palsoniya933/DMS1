({
    doInit : function(component, event, helper) {
        ...
        helper.updateTrackingDetails(component, event, helper,'Non-Y Saleable Report');
         component.set(
            'v.loadTime',
            Date.now()
        );
        window.addEventListener('beforeunload',function(){
            helper.updateTrackingTime(component, event, helper, 'Non-Y Saleable Report',component.get('v.loadTime'));
        });
        
	},
    
    fetchReportData : function(component, event, helper) {
            component.set("v.nonYSaleableReportData", []);
