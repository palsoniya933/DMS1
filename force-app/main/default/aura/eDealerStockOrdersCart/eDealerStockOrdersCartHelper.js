({
	getStockCartItems : function(component, event, helper) {
        ...
        var action = component.get("c.fetchSTOCKCartItemsDetails");
        action.setParams({
            "dealerCode": locCode
        });
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                component.set("v.cartStockOrders", response.getReturnValue());
            }
            else if (state === "ERROR") {
