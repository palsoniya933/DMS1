({
    doInit : function(component, event, helper) {
        ...
        helper.updateTrackingDetails(component, event, helper,'MDI Back Order Report');
         component.set(
            'v.loadTime',
            Date.now()
        );
        window.addEventListener('beforeunload',function(){
            helper.updateTrackingTime(component, event, helper, 'MDI Back Order Report',component.get('v.loadTime'));
        });
    },
    
    fetchInternalReportData : function(component, event, helper) {
        component.set("v.backOrdersReportData", []);        
