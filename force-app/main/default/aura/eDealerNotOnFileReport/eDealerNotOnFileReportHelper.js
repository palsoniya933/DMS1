({
    ...
    getReportData : function(component, event, helper, isDownload, offset) {    
        ...
        console.log('component.get("v.selectedFilters"): '+component.get("v.selectedFilters"))
        ...
        var action = component.get("c.fetchAWSNotOnFileReportData");
        console.log('JSON:::::'+JSON.stringify(reportGnerateObject));
        action.setParams({
            ...
            if (state === "SUCCESS") { 
                ...
                if(!$A.util.isEmpty(resultData.error)){
                    ...
                    if(!isDownload){
                        ...
                        component.set("v.notOnFileReportData", resultData.response);
    ...
    setGridColumns : function(component, event, helper) {
        ...
        for (const key in languageTranslation) {
            ...
            else if(value=='initialdate' || value=='enddate'){
                columns.push({label: value, fieldName: key.toLowerCase(), type: 'Date', sortable: false});
            }
                else{
